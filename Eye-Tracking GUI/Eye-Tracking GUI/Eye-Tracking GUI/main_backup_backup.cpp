...
#define MAXLINE 1024
#define BUFLEN 64
#define DSPACE_IP "137.148.204.222"          // dSPACE
...
void checkPos()             // This function checks the positions of the hand and eyes
{
    ...
    if (eyeX < transformedLocationInitial[0] + xEdge*5 && eyeX > transformedLocationInitial[0] -xEdge*5 && eyeY < transformedLocationInitial[1] + yEdge*5 && eyeY > transformedLocationInitial[1] -yEdge*5)
    {
        whiteSquareEye = true;
    }
    else
    ...
    if ( eyeX < transformedLocationFinal[0] + xEdge*5 && eyeX > transformedLocationFinal[0] - xEdge*5 && eyeY < transformedLocationFinal[1] + yEdge*5 && eyeY > transformedLocationFinal[1] - yEdge*5)
    {
        greenSquareEye = true;
    }
    else
