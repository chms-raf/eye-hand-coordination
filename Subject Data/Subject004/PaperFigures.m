...
clear; clc; close all
load Subject004fixationFilterM.mat
...
hold on
plot(vs*EyeHandFeedback.HandX(handOnsetIndices_EHF) - vs*604.8285,vs*EyeHandFeedback.HandY(handOnsetIndices_EHF) - vs*455.6125,'rx','MarkerSize',12,'LineWidth',2)
...
legend('Raw Hand Data','Estimated Hand Onsets','Targets')
...
hold on
plot(vs*fixations_EHF(:,1) - vs*604.8285, vs*fixations_EHF(:,2) - vs*455.6125,'x','MarkerSize',12,'LineWidth',2)
